# USTC网安大礼包食用方法
首先, 感谢nico电子资料共享群, 三三的女装更衣室 ( x ) 两个群聊的朋友们 ! ! !
...
-   参考书: 概率论与数理统计习题全解指南浙大第四版, 高等教育出版社, 盛骤
    -   这是一本习题集, 和考试内容接近
...
-   教材: 信息论基础 ( 原书第二版 ) , 机械工业出版社, Thomas M. Cover
...
-   参考书: 电路基础 ( 第三版 ) 教学指导书, 西安电子科技大学出版社, 王松林
    -   一本难度适中的习题集, 和考试内容相近
...
-   教材: 数字电子技术基础 ( 第六版 ) , 高等教育出版社, 阎石
-   参考书: 数字电子技术基础 ( 第六版 ) 学习辅导与习题解答, 高等教育出版社, 阎石
...
-   教材: 操作系统精髓与设计原理 ( 第八版 ) , 电子工业出版社, William Stallings
...
-   教学内容: 网络安全综述, 公钥基础设施, IPSec的AH/ESP/IKE协议, SSL/TLS协议, 防火墙与NAT, VPN, 应用层安全协议, 无线网安全
-   实验内容: 文献调研, IETF工作调研, Linux防火墙配置与地址转换, OpenSSL系统分析和应用, GnuPG原理和使用, IPSecVPN搭建, FreeRadius搭建和使用, Linux下常见服务器搭建, PKI/CA体系和EJBCA的搭建
    -   这些内容做一个就行
    -   也可以自选题, 需要老师助教核定
